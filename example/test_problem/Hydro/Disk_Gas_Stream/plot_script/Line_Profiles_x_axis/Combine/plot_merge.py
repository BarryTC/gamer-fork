...
DirectoryPath   = "../"
plot_prefix     = "Data_"
plot_suffix_1   = "_line_plot_density.png"
plot_suffix_2   = "_line_plot_velocity_x.png"
plot_suffix_3   = "_line_plot_temperature.png"
plot_suffix_4   = "_line_plot_pressure.png"
...
for idx in range(idx_start,idx_end+1,didx):
    ...
    pz_dens_1 = matplotlib.image.imread(DirectoryPath+plot_prefix+"%06d"%idx+plot_suffix_1)
    pz_dens_2 = matplotlib.image.imread(DirectoryPath+plot_prefix+"%06d"%idx+plot_suffix_2)
    ...
    pz_dens_1 = matplotlib.image.imread(DirectoryPath+plot_prefix+"%06d"%idx+plot_suffix_3)
    pz_dens_2 = matplotlib.image.imread(DirectoryPath+plot_prefix+"%06d"%idx+plot_suffix_4)
    xdim_1,ydim_1,zdim_1 = pz_dens_1.shape
    xdim_2,ydim_2,zdim_2 = pz_dens_2.shape
    pz_dens_1_zero = np.zeros((max(xdim_1,xdim_2),max(ydim_1,ydim_2),max(zdim_1,zdim_2)))
    pz_dens_2_zero = np.zeros((max(xdim_1,xdim_2),max(ydim_1,ydim_2),max(zdim_1,zdim_2)))
