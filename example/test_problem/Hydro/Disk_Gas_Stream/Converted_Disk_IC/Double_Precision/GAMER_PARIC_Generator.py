...
with open('PAR_IC', 'wb') as output:
       output.write(Output_Mass.astype('d').tobytes())
       output.write(Output_Pos_x.astype('d').tobytes())
       output.write(Output_Pos_y.astype('d').tobytes())
       output.write(Output_Pos_z.astype('d').tobytes())
       output.write(Output_Vel_x.astype('d').tobytes())
       output.write(Output_Vel_y.astype('d').tobytes())
       output.write(Output_Vel_z.astype('d').tobytes())
       output.write(Output_ParType.astype('d').tobytes())
       output.write(Output_ParTag.astype('d').tobytes())
       output.write(Output_ParEnergy.astype('d').tobytes())
       output.write(Output_ParAngMom.astype('d').tobytes())
       output.write(Output_ParEnergyBac.astype('d').tobytes())
       output.write(Output_ParID.astype('d').tobytes())
output.close()
