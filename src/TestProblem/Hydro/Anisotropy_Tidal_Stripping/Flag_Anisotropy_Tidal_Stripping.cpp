...
extern double Subhalo_CM[3];


//-------------------------------------------------------------------------------------------------------
// Function    :  Flag_Anisotropy_Tidal_Stripping
// Description :  Flag cells for refinement for the Anisotropy Tidal Stripping test problem
//
// Note        :  1. Linked to the function pointer "Flag_User_Ptr" by Init_TestProb_Hydro_Anisotropy_Tidal_Stripping()
...
//      flag cells ture (for refinement) if lying within the target radius at each level
        const double dr[3]   = { Pos[0]-Subhalo_CM[0], Pos[1]-Subhalo_CM[1], Pos[2]-Subhalo_CM[2] };
