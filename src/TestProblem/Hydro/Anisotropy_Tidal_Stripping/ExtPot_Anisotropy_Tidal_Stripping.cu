...
2. This file is shared by both CPU and GPU
   ...
   GPU_Poisson/CUPOT_ExtPot_Anisotropy_Tidal_Stripping.cu -> CPU_Poisson/CPU_ExtPot_Anisotropy_Tidal_Stripping.cpp

3. Three steps are required to implement external potential

   I.   Set auxiliary arrays
        --> SetExtPotAuxArray_Anisotropy_Tidal_Stripping()

   II.  Specify external potential
        --> ExtPot_Anisotropy_Tidal_Stripping()

   III. Set initialization functions
        --> SetGPUExtPot_Anisotropy_Tidal_Stripping()
            SetCPUExtPot_Anisotropy_Tidal_Stripping()
            Init_ExtPot_Anisotropy_Tidal_Stripping()

4. The external potential major routine, ExtPot_Anisotropy_Tidal_Stripping(),
...
//-------------------------------------------------------------------------------------------------------
// Function    :  SetExtPotAuxArray_Anisotropy_Tidal_Stripping
// Description :  Set the auxiliary arrays ExtPot_AuxArray_Flt/Int[] used by ExtPot_Anisotropy_Tidal_Stripping()
//
// Note        :  1. Invoked by Init_ExtPot_Anisotropy_Tidal_Stripping()
...
//-------------------------------------------------------------------------------------------------------
void SetExtPotAuxArray_Anisotropy_Tidal_Stripping( double AuxArray_Flt[], int AuxArray_Int[] )
{
...
//-----------------------------------------------------------------------------------------
// Function    :  ExtPot_Anisotropy_Tidal_Stripping
...
//                2. Auxiliary arrays UserArray_Flt/Int[] are set by SetExtPotAuxArray_Anisotropy_Tidal_Stripping(), where
...
//-----------------------------------------------------------------------------------------
GPU_DEVICE_NOINLINE
static real ExtPot_Anisotropy_Tidal_Stripping( const double x, const double y, const double z, const double Time,
...
FUNC_SPACE ExtPot_t ExtPot_Ptr = ExtPot_Anisotropy_Tidal_Stripping;

//-----------------------------------------------------------------------------------------
// Function    :  SetCPU/GPUExtPot_Anisotropy_Tidal_Stripping
...
//
//                      SetExtPot_Anisotropy_Tidal_Stripping( ExtPot_t &CPUExtPot_Ptr, ExtPot_t &GPUExtPot_Ptr )
//
...
#ifdef __CUDACC__
__host__
void SetGPUExtPot_Anisotropy_Tidal_Stripping( ExtPot_t &GPUExtPot_Ptr )
{
...
void SetCPUExtPot_Anisotropy_Tidal_Stripping( ExtPot_t &CPUExtPot_Ptr )
{
...
void SetExtPotAuxArray_Anisotropy_Tidal_Stripping( double [], int [] );
void SetCPUExtPot_Anisotropy_Tidal_Stripping( ExtPot_t & );
#ifdef GPU
void SetGPUExtPot_Anisotropy_Tidal_Stripping( ExtPot_t & );
#endif

//-----------------------------------------------------------------------------------------
// Function    :  Init_ExtPot_Anisotropy_Tidal_Stripping
...
void Init_ExtPot_Anisotropy_Tidal_Stripping()
{
   ...
   SetExtPotAuxArray_Anisotropy_Tidal_Stripping( ExtPot_AuxArray_Flt, ExtPot_AuxArray_Int );
   SetCPUExtPot_Anisotropy_Tidal_Stripping( CPUExtPot_Ptr );
#  ifdef GPU
   SetGPUExtPot_Anisotropy_Tidal_Stripping( GPUExtPot_Ptr );
#  endif
