...
// ******************************************************************
   switch ( TESTPROB_ID )
   {
      ...
      case TESTPROB_HYDRO_ANISOTROPY_TIDAL_STRIPPING :   Init_TestProb_Hydro_Anisotropy_Tidal_Stripping();  break;
      case TESTPROB_HYDRO_BH_BUOYANCY :                  Init_TestProb_Hydro_BH_Buoyancy();                 break;
      case TESTPROB_HYDRO_GLOBAL_FRICTION_EVOLUTION :    Init_TestProb_Hydro_Global_Friction_Evolution();   break;
      case TESTPROB_HYDRO_DISK_GAS_STREAM :              Init_TestProb_Hydro_Disk_Gas_Stream();             break;
